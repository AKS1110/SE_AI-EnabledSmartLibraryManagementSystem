...
% Set uniform border thickness and padding for images
\setlength{\fboxrule}{0.2pt}
\setlength{\fboxsep}{0pt}

\title{\textbf{AI-Enabled Smart Library Management and Resource Recommendation System}}
\author{Aradhya Goyal (Roll No: 1024160135) \\ Amanjot Kaur Sidhu (Roll No: 1024160025) \\ Arnav Agarwal (Roll No: 1024160010)}
\date{August 25, 2026}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth,height=0.4\textheight,keepaspectratio]{Use-Case-Diagram.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=0.4\textheight,keepaspectratio]{Level_0_DFD.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth,height=0.4\textheight,keepaspectratio]{Level_2_DFD.png}}
